...
export type BpnetPrediction = {
  __typename?: 'BpnetPrediction';
  allele1Motif?: Maybe<Array<Maybe<Array<Maybe<Scalars['Float']>>>>>;
  allele1PredCount?: Maybe<Scalars['Int']>;
  allele1TFFamily?: Maybe<Scalars['String']>;
  allele2Motif?: Maybe<Array<Maybe<Array<Maybe<Scalars['Float']>>>>>;
  allele2PredCount?: Maybe<Scalars['Int']>;
  allele2TFFamily?: Maybe<Scalars['String']>;
  cellType: Scalars['String'];
  dataset: Scalars['String'];
  id: Scalars['ID'];
  isTemporary: Scalars['Boolean'];
  jsd?: Maybe<Scalars['Float']>;
  jsdPval?: Maybe<Scalars['Float']>;
  logfc?: Maybe<Scalars['Float']>;
  logfcMaxPercentile?: Maybe<Scalars['Float']>;
  logfcMaxPercentilePval?: Maybe<Scalars['Float']>;
  logfcPval?: Maybe<Scalars['Float']>;
  maxPercentile?: Maybe<Scalars['Float']>;
};
...
export type DataTrack = {
  __typename?: 'DataTrack';
  bioSample: Scalars['String'];
  bioSampleID: Scalars['String'];
  cellType: Scalars['String'];
  fileFormat: Scalars['String'];
  id: Scalars['ID'];
  trackSubType?: Maybe<Scalars['String']>;
...
export type EnhancerGenePrediction = {
  __typename?: 'EnhancerGenePrediction';
  cellType: Scalars['String'];
  dataset: Scalars['String'];
  datatrackURL?: Maybe<Scalars['String']>;
  enhancerClass: Scalars['String'];
  enhancerEnd: Scalars['Int'];
  enhancerStart: Scalars['Int'];
  enhancerToGeneDistance: Scalars['Float'];
  id: Scalars['ID'];
  isTemporary: Scalars['Boolean'];
  ...
  score: Scalars['Float'];
  targetGene: Gene;
  targetGenePromoterActivityQuantile: Scalars['Float'];
  targetGeneTss: Scalars['Int'];
  variantToGeneDistance: Scalars['Float'];
};
...
export type LinkageDisequilibrium = {
  __typename?: 'LinkageDisequilibrium';
  dPrime: Scalars['Float'];
  egCellTypes: Array<Scalars['String']>;
  egGenes: Array<Scalars['String']>;
  id: Scalars['ID'];
  mostSevereConsequence?: Maybe<Scalars['String']>;
  r2: Scalars['Float'];
  variantId: Scalars['String'];
  variantPosition: Scalars['Int'];
  variantRsId: Scalars['String'];
};
...
export type Query = {
  ...
  linkageDisequilibriumsForVariant?: Maybe<Array<LinkageDisequilibrium>>;
  manhattan: Manhattan;
...
export type QueryLinkageDisequilibriumsForVariantArgs = {
  variantId: Scalars['String'];
};
...
export type QueryVariantInfoExtArgs = {
  variantId: Scalars['String'];
};
...
export type Variant = {
  ...
  bpnetPredictions?: Maybe<Array<BpnetPrediction>>;
  ...
  enhancerGenePredictions?: Maybe<Array<EnhancerGenePrediction>>;
  ...
  uniqueEnhancerGenePredictionCellTypes?: Maybe<Array<Scalars['String']>>;
  uniqueEnhancerGenePredictionTargetGenes?: Maybe<Array<Gene>>;
};
...
export type DataTracksTableQueryVariables = Exact<{ [key: string]: never; }>;


export type DataTracksTableQuery = { __typename?: 'Query', getDataTracks: Array<{ __typename?: 'DataTrack', id: string, url: string, cellType: string, bioSample: string, bioSampleID: string, trackType: string, trackSubType?: string | null, fileFormat: string }> };
...
export type VariantLinkageDisequilibriumFragment = { __typename?: 'LinkageDisequilibrium', id: string, variantId: string, variantRsId: string, variantPosition: number, r2: number, dPrime: number, egCellTypes: Array<string>, egGenes: Array<string>, mostSevereConsequence?: string | null } & { ' $fragmentName'?: 'VariantLinkageDisequilibriumFragment' };

export type VariantLinkageDisequilibriumQueryVariables = Exact<{
  variantId: Scalars['String'];
}>;


export type VariantLinkageDisequilibriumQuery = { __typename?: 'Query', linkageDisequilibriumsForVariant?: Array<(
    { __typename?: 'LinkageDisequilibrium' }
    & { ' $fragmentRefs'?: { 'VariantLinkageDisequilibriumFragment': VariantLinkageDisequilibriumFragment } }
  )> | null };
...
export type VariantPageEnhancerGenePredictionFragment = { __typename?: 'EnhancerGenePrediction', id: string, score: number, cellType: string, variantToGeneDistance: number, enhancerStart: number, enhancerClass: string, enhancerEnd: number, targetGeneTss: number, enhancerToGeneDistance: number, pip: number, model: string, dataset: string, isTemporary: boolean, datatrackURL?: string | null, targetGene: { __typename?: 'Gene', id: string, symbol?: string | null } } & { ' $fragmentName'?: 'VariantPageEnhancerGenePredictionFragment' };

export type VariantPageBpnetPredictionFragment = { __typename?: 'BpnetPrediction', id: string, logfc?: number | null, logfcPval?: number | null, jsd?: number | null, jsdPval?: number | null, maxPercentile?: number | null, logfcMaxPercentile?: number | null, logfcMaxPercentilePval?: number | null, allele1PredCount?: number | null, allele2PredCount?: number | null, allele1TFFamily?: string | null, allele2TFFamily?: string | null, allele1Motif?: Array<Array<number | null> | null> | null, allele2Motif?: Array<Array<number | null> | null> | null, cellType: string, dataset: string, isTemporary: boolean } & { ' $fragmentName'?: 'VariantPageBpnetPredictionFragment' };
...
export type VariantSummaryQuery = { __typename?: 'Query', variantInfo?: { __typename?: 'Variant', id: string, rsId?: string | null, chromosome: string, position: number, chromosomeB37?: string | null, positionB37?: number | null, refAllele: string, altAllele: string, nearestGeneDistance?: number | null, nearestCodingGeneDistance?: number | null, mostSevereConsequence?: string | null, caddRaw?: number | null, caddPhred?: number | null, gnomadAFR?: number | null, gnomadAMR?: number | null, gnomadASJ?: number | null, gnomadEAS?: number | null, gnomadFIN?: number | null, gnomadNFE?: number | null, gnomadNFEEST?: number | null, gnomadNFENWE?: number | null, gnomadNFESEU?: number | null, gnomadOTH?: number | null, uniqueEnhancerGenePredictionCellTypes?: Array<string> | null, nearestGene?: { __typename?: 'Gene', id: string, symbol?: string | null } | null, nearestCodingGene?: { __typename?: 'Gene', id: string, symbol?: string | null } | null, uniqueEnhancerGenePredictionTargetGenes?: Array<{ __typename?: 'Gene', id: string, symbol?: string | null }> | null, bpnetPredictions?: Array<{ __typename?: 'BpnetPrediction', logfc?: number | null, logfcPval?: number | null, cellType: string }> | null } | null };

export const VariantLinkageDisequilibriumFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"VariantLinkageDisequilibrium"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"LinkageDisequilibrium"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"variantId"}},{"kind":"Field","name":{"kind":"Name","value":"variantRsId"}},{"kind":"Field","name":{"kind":"Name","value":"variantPosition"}},{"kind":"Field","name":{"kind":"Name","value":"r2"}},{"kind":"Field","name":{"kind":"Name","value":"dPrime"}},{"kind":"Field","name":{"kind":"Name","value":"egCellTypes"}},{"kind":"Field","name":{"kind":"Name","value":"egGenes"}},{"kind":"Field","name":{"kind":"Name","value":"mostSevereConsequence"}}]}}]} as unknown as DocumentNode<VariantLinkageDisequilibriumFragment, unknown>;
...
export const VariantPageEnhancerGenePredictionFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"VariantPageEnhancerGenePrediction"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"EnhancerGenePrediction"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"score"}},{"kind":"Field","name":{"kind":"Name","value":"cellType"}},{"kind":"Field","name":{"kind":"Name","value":"score"}},{"kind":"Field","name":{"kind":"Name","value":"variantToGeneDistance"}},{"kind":"Field","name":{"kind":"Name","value":"enhancerStart"}},{"kind":"Field","name":{"kind":"Name","value":"enhancerClass"}},{"kind":"Field","name":{"kind":"Name","value":"enhancerEnd"}},{"kind":"Field","name":{"kind":"Name","value":"targetGeneTss"}},{"kind":"Field","name":{"kind":"Name","value":"enhancerToGeneDistance"}},{"kind":"Field","name":{"kind":"Name","value":"pip"}},{"kind":"Field","name":{"kind":"Name","value":"model"}},{"kind":"Field","name":{"kind":"Name","value":"dataset"}},{"kind":"Field","name":{"kind":"Name","value":"isTemporary"}},{"kind":"Field","name":{"kind":"Name","value":"datatrackURL"}},{"kind":"Field","name":{"kind":"Name","value":"targetGene"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"symbol"}}]}}]}}]} as unknown as DocumentNode<VariantPageEnhancerGenePredictionFragment, unknown>;
export const VariantPageBpnetPredictionFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"VariantPageBpnetPrediction"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"BpnetPrediction"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"logfc"}},{"kind":"Field","name":{"kind":"Name","value":"logfcPval"}},{"kind":"Field","name":{"kind":"Name","value":"jsd"}},{"kind":"Field","name":{"kind":"Name","value":"jsdPval"}},{"kind":"Field","name":{"kind":"Name","value":"maxPercentile"}},{"kind":"Field","name":{"kind":"Name","value":"logfcMaxPercentile"}},{"kind":"Field","name":{"kind":"Name","value":"logfcMaxPercentilePval"}},{"kind":"Field","name":{"kind":"Name","value":"allele1PredCount"}},{"kind":"Field","name":{"kind":"Name","value":"allele2PredCount"}},{"kind":"Field","name":{"kind":"Name","value":"allele1TFFamily"}},{"kind":"Field","name":{"kind":"Name","value":"allele2TFFamily"}},{"kind":"Field","name":{"kind":"Name","value":"allele1Motif"}},{"kind":"Field","name":{"kind":"Name","value":"allele2Motif"}},{"kind":"Field","name":{"kind":"Name","value":"cellType"}},{"kind":"Field","name":{"kind":"Name","value":"dataset"}},{"kind":"Field","name":{"kind":"Name","value":"isTemporary"}}]}}]} as unknown as DocumentNode<VariantPageBpnetPredictionFragment, unknown>;
...
export const DataTracksTableDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DataTracksTable"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getDataTracks"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"url"}},{"kind":"Field","name":{"kind":"Name","value":"cellType"}},{"kind":"Field","name":{"kind":"Name","value":"bioSample"}},{"kind":"Field","name":{"kind":"Name","value":"bioSampleID"}},{"kind":"Field","name":{"kind":"Name","value":"trackType"}},{"kind":"Field","name":{"kind":"Name","value":"trackSubType"}},{"kind":"Field","name":{"kind":"Name","value":"fileFormat"}}]}}]}}]} as unknown as DocumentNode<DataTracksTableQuery, DataTracksTableQueryVariables>;
...
export const VariantLinkageDisequilibriumDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"VariantLinkageDisequilibrium"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"variantId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"linkageDisequilibriumsForVariant"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"variantId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"variantId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"VariantLinkageDisequilibrium"}}]}}]}},...VariantLinkageDisequilibriumFragmentDoc.definitions]} as unknown as DocumentNode<VariantLinkageDisequilibriumQuery, VariantLinkageDisequilibriumQueryVariables>;
