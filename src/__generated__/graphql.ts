...
export type VariantPageAbcPredictionFragment = { __typename?: 'AbcPrediction', id: string, score: number, cellType: string, variantToGeneDistance: number, enhancerStart: number, enhancerClass: string, enhancerEnd: number, targetGeneTss: number, targetGenePromoterActivityQuantile: number, enhancerToGeneDistance: number, abcVariantPosition: number, pip: number, targetGene: { __typename?: 'Gene', id: string, symbol?: string | null } } & { ' $fragmentName'?: 'VariantPageAbcPredictionFragment' };
