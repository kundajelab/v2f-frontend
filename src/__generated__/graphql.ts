...
export type Variant = {
  __typename?: 'Variant';
  abcPredictions: Array<AbcPrediction>;
  altAllele: Scalars['String'];
  bpnetPredictions: Array<BpnetPrediction>;
