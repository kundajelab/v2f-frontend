...
export type VariantPageEnhancerGenePredictionFragment = { __typename?: 'EnhancerGenePrediction', id: string, score: number, cellType: string, enhancerStart: number, enhancerClass: string, enhancerEnd: number, targetGeneTss: number, enhancerToGeneDistance: number, model: string, dataset: string, datatrack: { __typename?: 'DataTrack', id: string, atacSignalUrl?: string | null, dnaseSignalUrl?: string | null, e2gPredictionsUrl?: string | null, elementsUrl?: string | null }, targetGene: { __typename?: 'Gene', id: string, symbol?: string | null } } & { ' $fragmentName'?: 'VariantPageEnhancerGenePredictionFragment' };
