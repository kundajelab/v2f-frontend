...
export type AbcPrediction = {
  __typename?: 'AbcPrediction';
  abcVariantPosition: Scalars['Int'];
...
export type Variant = {
  __typename?: 'Variant';
  abcPredictions?: Maybe<Array<AbcPrediction>>;
  ...
  uniqueAbcPredictionCellTypes?: Maybe<Array<Scalars['String']>>;
  uniqueAbcPredictionTargetGenes?: Maybe<Array<Gene>>;
};
...
export type VariantPageAbcPredictionFragment = { __typename?: 'AbcPrediction', id: string, score: number, cellType: string, variantToGeneDistance: number, enhancerStart: number, enhancerClass: string, enhancerEnd: number, targetGeneTss: number, targetGenePromoterActivityQuantile: number, enhancerToGeneDistance: number, abcVariantPosition: number, pip: number, model: string, dataset: string, isTemporary: boolean, targetGene: { __typename?: 'Gene', id: string, symbol?: string | null } } & { ' $fragmentName'?: 'VariantPageAbcPredictionFragment' };
