...
export type LinkageDisequilibrium = {
  ...
  r2: Scalars['Float'];
  variantGnomadId: Scalars['String'];
...
export type VariantLinkageDisequilibriumFragment = { __typename?: 'LinkageDisequilibrium', variantGnomadId: string, variantRsId: string, r2: number, dPrime: number, egCellTypes: Array<string>, egGenes: Array<string>, mostSevereConsequence?: string | null } & { ' $fragmentName'?: 'VariantLinkageDisequilibriumFragment' };
