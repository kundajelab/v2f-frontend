...
export type DataTracksTableQuery = { __typename?: 'Query', getDataTracks: Array<{ __typename?: 'DataTrack', id: string, url: string, cellType: string, bioSample: string, trackType: string, trackSubType?: string | null, fileFormat: string }> };
