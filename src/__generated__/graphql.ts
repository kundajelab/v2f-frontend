...
export type VariantLinkageDisequilibriumFragment = { __typename?: 'LinkageDisequilibrium', variantGnomadId: string, variantRsId: string, r2: number, dPrime: number } & { ' $fragmentName'?: 'VariantLinkageDisequilibriumFragment' };
