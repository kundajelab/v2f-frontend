...
export type VariantPageEnhancerGenePredictionFragment = { __typename?: 'EnhancerGenePrediction', id: string, score: number, cellType: string, variantToGeneDistance: number, enhancerStart: number, enhancerClass: string, enhancerEnd: number, targetGeneTss: number, targetGenePromoterActivityQuantile: number, enhancerToGeneDistance: number, pip: number, model: string, dataset: string, isTemporary: boolean, targetGene: { __typename?: 'Gene', id: string, symbol?: string | null } } & { ' $fragmentName'?: 'VariantPageEnhancerGenePredictionFragment' };
